  ...
  return (
    <>
      <SectionWrapper BGColor={bgColor} Padding={true}>
        ...
        {caseStudyLayout === "5" && (
  <div className="flex flex-col lg:flex-row justify-start items-center gap-8 w-full h-auto lg:h-[362px]" style={{ color: casestudy[0].color }}>
    <div
    ...
    >
      ...
      <p className="w-full lg:w-[80%] mb-4">{casestudy[0].description}</p>
    </div>
    <div
