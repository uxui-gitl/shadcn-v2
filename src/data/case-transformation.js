 const transformationData = [
     {
        ...
        challenges: {
          description: "The Customer was facing the following businesschallenge:",
          keyChallenges: [
      ...
      },
      {
        ...
        challenges: {
          description: "Customer were facing challenges with regardst:",
          keyChallenges: [
...

      {
        ...
        solution: {
          ...
          features: [
            ...
            "Improved PurchaseProces: Excess spending is controlled by introducing the authorized purchase requisition process",
            "WarrantyAccountin: Warranty process is streamlined by automatic creation of Debit and Credit Note for posting into pre-configured expense and liability accounts.",
            "Customer, Supplier and ItemDashboard: The CRM dashboard displays key data points such as credit limit, available credit, order balance and invoice balance for respective customers. Similarly, Supplier and Inventory dashboards publish correlated analytic data into a single consolidated view.",
            "Easier WarehouseTransfer: Creation of standard system processes for initiating warehouse transfers leads to faster logistic throughput.",
            "Easier DocumentManagemen: Object data management (ODM) technology allows for attaching documents to different artifacts that are created during the business processes.",
            "Landed CostCalculato: Product costing across warehouses is standardized by accounting for global shipment regulations based on item classification, source and destination country."
        ...
        benefits: {
          ...
          list: [
            "Inventory Tracking andContro: Transparency of stock movement across warehouses, better invoice management of incoming supplies and advanced recording of shipment details lead to a well streamlined and efficient inventory system.",
            "End UserExperienc: Features such as intuitive customer coding, visual representation of items and partners and auto import export of data leads to ease of operations for end users.",
            "WorkforceProductivit: Automatic conversion of purchase requisition to purchase orders saves considerable amount of data entry time and effort."
        ]
        },
        meta: {
          title: "",
...

      {
        ...
        benefits: {
          description: "The implementation of INFOR LN FP 7 led to innumerable benefits for the client sucha:",
          list: [
 ...
 
      {
        ...
        solution: {
          description: "Godrej Infotech Ltd. (GITL) was selected as the partner for upgrading the existing ERP system by adding new modules including development of POS solution and enhancing earlier modules. The solution developed by GITL had the followingfeature:",
          features: [
        ...
        benefits: {
          description: "Post implementation, there has been a 360 degree turnaround in the efficiency of the customer’s business operations. The new system brings with it multiple benefits sucha:",
          list: [
...

      {
        ...
        customerBrief: {
         description: "The client is an ISO900:2008 certified company specializing in state-of-the-art manufacturing of oil field equipments such as BOP Control Units, Test Units, Water Blaster, Flanges, Crosses, Tees, Ring Joint Gaskets, Adapters and Spacer Spools. Their products consistently meet or exceed the API – 6A, 16A, 16C and 16D specifications. The manufacturing facility is spread over 10 acres and also includes production of sword armors, handicrafts, and retailing of licensed Hollywood props. In addition to manufacturing units in India, the client also has a modern trading facility in the Middle East.",
            BriefList: []
        },
        businessCase: {
          description: "The client was already using an ERP solution for their ad-hoc needs. They were facing multiple issues in their day-to-day operations sucha:",
          businesscaseList: [
        ...
        challenges: {
          description: "An implementation of this scale was successful due to the continuous support provided by the key stakeholders and senior management members from both, the client organization and Godrej Infotech Limited. Some of the roadblocks faced were due to thefollowin:",
          keyChallenges: [
        ...
        benefits: {
          description: "Once implemented, the benefits of this Infor solution have been tremendous. Some of the highlightsar:",
          list: [
...

      {
        ...
        businessCase: {
          description: "The client was running a home grown IT system based on ad-hoc needs. Primary systems used were Microsoft Excel and e-mail, which led to huge operational inefficiencies. Majority of the issues faced were relatedt:",
          businesscaseList: [
        ...
        benefits: {
          description: "The benefits of using Infor LN FP 10.4 experienced by the client are asfollow:",
          list: [
...

      {
        ...
        businessCase: {
          description: "The organization was facing many challenges with regards to the existing legacy software system. The objectives for the new implementation were asfollow:",
          businesscaseList: [
...

      {
        ...
        businessCase: {
          description: "The Customer was using NAV 2013 which is currently not supported by Microsoft. Hence, they were looking to upgrade to NAV 2016 for using new standard features and building enhancements relatedt:",
          businesscaseList: [
            "GST & e-invoicing",
...

      {
        ...
        highlights: {
          industry: " Beverage bottling company",
          projectLocation: "Kingdom of Saudi Arabia",
          engagementSince: "2010",
          solutionSnapshot: [
            ""
