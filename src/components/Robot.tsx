...
const Robot = () => {
  ...
  return (
    <CardContainer className="flex justify-center items-center mx-auto mb-40 px-4 sm:px-0">
      <CardBody className="bg-transparent w-full   mx-auto overflow-hidden h-auto relative p-6">
