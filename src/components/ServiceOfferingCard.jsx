...
function ServiceOfferingCard({Item}) {
    ...
    return (
        <>
            <div class="w-full rounded-3xl bg-white shadow" style={{ minHeight: '600px', maxHeight: '600px', maxWidth: '575px', overflow:'hidden' }}>
                <div class="p-5">
                ...
                <img class="rounded-3xl" src={cardImageUrl} alt="any"/>
                </div>
            </div>
