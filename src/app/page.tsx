...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* banner slider */}
      <div className="slider-wrapper bg-black h-[80vh] sm:h-[80vh] md:h-[100vh]">
        <div className="video relative" style={{ height: "inherit" }}>
          ...
          ></div>
          <div className="container headline-position mx-auto text-[48px] sm:text-[56px] md:text-[64px] lg:text-[48px] xl:text-[64px] 2xl:text-[76px] 3xl:text-[96px] leading-[1.2] text-white absolute ">
          ...
          <hr className="h-px my-8 bg-[#e5e7eb5c] border-0 absolute horizontal-line"></hr>
          {/* slider */}
          <div
            className="container mx-auto sm:h-30 md:h-60"
            style={{
              position: "absolute",
              width: "100%",
              bottom: "0",
          ...
          >
            ...
            >
                    ...
                    <SwiperSlide key={item.id}>
                      <div className="w-full py6 bg-transparent rounded-3xl">
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                          ...
                          >
                            <div className="case-study-title text-[#fff] text-[20px] font-semibold ">
                              {item.title}
                            </div>
                          </motion.div>
                          <motion.div
              ...
              <div className="w-[30%] relative flex gap-4 items-center">
  <div className="swiper-button-next swiper-button-size flex items-center justify-center w-[24px] h-[24px]
                  sm:w-[56px] sm:h-[56px] md:w-[64px] md:h-[64px] 
                  lg:w-[72px] lg:h-[72px] xl:w-[80px] xl:h-[80px]">
    <Image src="/homeNew/btn-arrows-right.svg" alt="Next" layout="responsive" width={48} height={48} />
  </div>
  <div className="swiper-button-prev swiper-button-size flex items-center justify-center w-[24px] h-[24px]
                  sm:w-[56px] sm:h-[56px] md:w-[64px] md:h-[64px] 
                  lg:w-[72px] lg:h-[72px] xl:w-[80px] xl:h-[80px]">
    <Image src="/homeNew/btn-arrows-left.svg" alt="Prev" layout="responsive" width={48} height={48} />
  </div>
</div>
      ...
      >
        <div className="grid grid-cols-4 gap-16 py-6">
          <div className="" ref={ref1}>
            <h1 className="text-[96px] font-[700] text-white">
              {count1}
