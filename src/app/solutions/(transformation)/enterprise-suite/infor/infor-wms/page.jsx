...
const page = () => {
  ...
  const TESTIMONIAL_DATA = [
    {
      ...
      cardDesc: 'Thanks to GITL for the excellent work for cloud-enabling our Infor environment. The services provided were of high quality and we recommend Godrej Infotech as a professional cloud services provider.',
    ...
    },
    {
      ...
      cardDesc: 'We have received timely inputs and guidance across the modules that have been implemented on the system.',
  ...
  const CHALLENGES_LIST_DATA = [
    { id: 1, title: "Meet tight turnaround times despite complex inventory and logistics", icon: '/upgradeCloud/icons/ico--target.svg' },
    { id: 2, title: "Reduce manual errors and increase labour productivity", icon: '/upgradeCloud/icons/ico--target.svg' },
    { id: 3, title: "Managing inventory obsolescence and waste", icon: '/upgradeCloud/icons/ico--target.svg' },
    { id: 4, title: "Adopting to constantly shifting customer requirements", icon: '/upgradeCloud/icons/ico--target.svg' },
    { id: 5, title: "Supply chain disruptions and delays", icon: '/upgradeCloud/icons/ico--target.svg' },
  ];
  ...
  return (
    <>
      <EntIntro
        title="Streamline warehouse operations with Infor WMS's integrated workflows"
      ...
      <ChallengeSection
        ...
        setDesc={'Warehouses face growing challenges to meet customer demands for speed, availability, and affordability. '}
      />
      ...
      <CommonCardThreeSlider
        ...
        sectionDesc={'Infor WMS optimizes warehouse operations with goods tracking and management, from initial receipt to final dispatch.'}
      ...
      <SectionWithSlider
        ...
        sectionDesc={"Enhancing the features of business applications, our specialized solutions intend to add value to business with handy support, streamlined processes and intense industry expertise."}
      ...
      <BenefitSliderSection
        ...
        sectionDesc={'Discover a more efficient, accurate and customer-centric supply chain with Infor WMS.'}
      ...
      <BlogSection
        ...
        Heading={"How does Infor WMS Enhances Visibility and Control in Warehousing?"}
        Desc={
      ...
      <TransformBusinessForm
        ...
        Desc={
          "Let us discuss how Infor WMS can help you with rapid growth."
        }
      ></TransformBusinessForm>
