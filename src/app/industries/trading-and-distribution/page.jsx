...
function page() {
  ...
  const CHALLENGES_LIST_DATA = [
    {
      id: 1,
      title: "Overcoming tight delivery deadline constraints",
      icon: "/upgradeCloud/icons/challengesIcon.svg",
    },
    {
      id: 2,
      title: "Mitigating supplier non-compliance risks",
      icon: "/upgradeCloud/icons/challengesIcon.svg",
    },
    {
      id: 3,
      title: "Resolving supply chain visibility gaps",
      icon: "/upgradeCloud/icons/challengesIcon.svg",
    },
    {
      id: 4,
      title: "Coping with stock management and transfer inefficiencies",
      icon: "/upgradeCloud/icons/challengesIcon.svg",
    },
    {
      id: 5,
      title: "Navigating diverse product line complexities",
      icon: "/upgradeCloud/icons/challengesIcon.svg",
    },
  ];
  ...
  const RPASolution2 = [
    {
      ...
      cardDesc:
        "Meticulous analysis of current business operations, IT framework and accordingly develop tailored strategy for optimal business growth.",
      isArrow: false,
      cardTextColor: "black",
    ...
    },
    {
      ...
      cardDesc:
        "We ensure seamless solution execution and worldwide deployment leveraging our expertise.",
      isArrow: false,
      cardTextColor: "black",
    ...
    },
    {
      ...
      cardDesc:
        "Helping organisations to unburden their IT operations with expert-managed services, ensuring higher efficiency.",
      isArrow: true,
      cardTextColor: "black",
    ...
    },
    {
      ...
      cardDesc:
        "Future-proof business by modernizing legacy systems and optimizing overall performance.",
      isArrow: true,
      cardTextColor: "black",
...

    {
      ...
      cardDesc:
        "Stay agile and scalable with infrastructure as a service, without the obligation of managing infrastructure and hardware maintenance.",
      isArrow: true,
      cardTextColor: "black",
  ...
  const CASE_STUDIES_DATA = [
    {
      ...
      heading: "",
      description:
        "Gain valuable insights on digital transformation journeys of trading & distribution businesses.",
      link: "",
      color: "#FFFFFF",
      bgCardColor: "#2B1624",
    },
    {
      ...
      title: "",
      heading:
        "Significant Cost Savings & Increase in Inter-departmental Synergy",
      description:
  ...
  return (
    <>
      ...
      />
      <OverviewSection
        Text={`We offer effective solutions for trading and distribution businesses, ensuring warehouse governance, maximum perfect order fulfilment and optimized distribution operations for customers.`}
      />
      <SectionWrapper
      ...
      <SectionWrapperNew
        ...
        sectionDesc={
          "Trading and distribution businesses must adopt innovative solutions for scalable infrastructure and increased revenue growth"
        }
            ...
            <SwiperSlide key={index}>
              <div className="p-6 bg-[transparent] border-[0.5px] border-white rounded-3xl border-opacity-20 min-h-[424px]">
                <Image
                  ...
                  className="mb-4"
                />
                <div className="text-heading-02 leading-heading-02 font-semibold text-neutral-white">
                  {item.CardHeading}
                </div>
                <p className="text-body-01 leading-body-01 py-4 text-neutral-white">
                  {item.CardDesc}
                </p>
                <div
      ...
      <AcceleratorSection
        ...
        Color={""}
      >
        <p className="text-heading-02 leading-heading-02 font-semibold mb-4">
          Dealer Management Desk
        </p>
        <p className="text-body-01 leading-body-01">
          .NET portal integrated with Dynamics Navision streamlines dealer
          management through online registration, contract management.
          Leveraging Azure cloud infrastructure, the portal enables secure
          remote onboarding, efficient order processing and payment management.
        </p>
      </AcceleratorSection>
            ...
            <SwiperSlide key={index}>
              <div class="w-full min-h-[50vh] bg-white rounded-3xl group overflow-hidden relative border-[0.5px] border-primary-900 border-opacity-20">
                ...
                <div className="h-[25vh] p-5 relative">
                  <h5 className="mb-4 text-heading-02 leading-heading-02 text-primary-900 font-semibold ">
                    {item?.cardHeading}
                  </h5>
                  <p className="mb-6 text-body-01 leading-body-01 text-primary-900 font-normal">
                    {item?.cardDesc}
                  </p>
                  {item?.cardHoverData && (
      ...
      <IndustrySpotlight
        ...
        sectionDesc={
          "We leverage domain knowledge and digital transformation expertise to tackle specific challenges in multiple trading and distribution sectors."
        }
      />
      <CaseStudiesSection
      ...
      <ReviewSliderSection
        ...
        Desc={
          "Discover how we have helped our customers to realize tangible outcomes aligned with their business goals."
        }
        Color="text-neutral-white"
      ...
      <TransformBusinessForm
        ...
        Desc={
          "Let us discuss how Trading and Distribution can help you with rapid growth."
        }
      ></TransformBusinessForm>
    </>
  );
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-20 h-full">
      <div className="p-5">
        {services.map((item) => (
          <>
            <div
              className="list text-body-01 py-3 flex justify-between last:border-none"
      ...
      <div
        ...
        style={{
          backgroundImage: `url(/tradingDistribution/solutionOfferings/automation.webp)`,
          backgroundSize: "cover",
        }}
      ></div>
    </div>
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-20 h-full">
      ...
      <div
        className="relative invisible md:visible"
        style={{
          backgroundImage: `url(/tradingDistribution/solutionOfferings/cloud.webp)`,
          backgroundSize: "cover",
        }}
      ></div>
    </div>
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-20 h-full">
      ...
      <div
        className="relative invisible md:visible"
        style={{
          backgroundImage: `url(/tradingDistribution/solutionOfferings/transformation.webp)`,
          backgroundSize: "cover",
        }}
      ></div>
    </div>
