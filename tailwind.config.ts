  ...
  theme: {
    ...
    extend: {
      fontSize: {
        ...
        'sm-paragraph-01': 'clamp(16px, 3vw, 18px)',
        'sm-body-01': 'clamp(16px, 3vw, 18px)',
        'sm-label-01': 'clamp(14px, 2vw, 16px)',
        'sm-helper-text-01': 'clamp(12px, 1.5vw, 14px)',
        
        'md-display-01': 'clamp(54px, 9vw, 64px)',
        'md-heading-01': 'clamp(26px, 5.5vw, 36px)',
        'md-paragraph-01': 'clamp(18px, 3.5vw, 20px)',
        'md-body-01': 'clamp(18px, 3.5vw, 20px)',
        'md-label-01': 'clamp(16px, 2.5vw, 18px)',
        'md-helper-text-01': 'clamp(14px, 2vw, 16px)',
        
        'lg-display-01': 'clamp(64px, 10vw, 72px)',
        'lg-heading-01': 'clamp(28px, 6vw, 40px)',
        'lg-paragraph-01': 'clamp(20px, 4vw, 22px)',
        'lg-body-01': 'clamp(20px, 4vw, 22px)',
        'lg-label-01': 'clamp(18px, 3vw, 20px)',
        'lg-helper-text-01': 'clamp(16px, 2.5vw, 18px)',
        
        'xl-display-01': 'clamp(72px, 11vw, 96px)',
        'xl-heading-01': 'clamp(30px, 6.5vw, 44px)',
        'xl-paragraph-01': 'clamp(22px, 4.5vw, 24px)',
        'xl-body-01': 'clamp(22px, 4.5vw, 24px)',
        'xl-label-01': 'clamp(20px, 3.5vw, 22px)',
        'xl-helper-text-01': 'clamp(18px, 2.5vw, 20px)',
        
        '2xl-display-01': 'clamp(96px, 12vw, 112px)',
        '2xl-heading-01': 'clamp(32px, 7vw, 48px)',
        '2xl-paragraph-01': 'clamp(24px, 5vw, 26px)',
        '2xl-body-01': 'clamp(24px, 5vw, 26px)',
        '2xl-label-01': 'clamp(22px, 4vw, 24px)',
        '2xl-helper-text-01': 'clamp(20px, 3vw, 22px)',      
      },
      letterSpacing: {
        'display-01': '-0.015em',
        'heading-01': '-0.012em',
